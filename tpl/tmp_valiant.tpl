...
<form id="stdform" method="post" action="tmp_valiant.php">
<div class="areaopac color3">
    ...
    <div style="padding-left:20px; padding-right:20px;">
        ...
        <br />
        <b>Please also choose 1 of the following:</b>
        <ul>
            <!-- START BLOCK : opt2_list -->
            <li><input type="radio" name="chosenopt2" value="{val}" {opt}> 1x {name} {plus}</li>                       
            <!-- END BLOCK : opt2_list -->
        </ul>            
