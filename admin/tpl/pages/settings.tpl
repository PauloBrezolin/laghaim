            ...
            <tr>
                <td class="menua">
                    <ul>
                        ...
                        <li><a href="settings.php" class="active"><i class="material-icons">&#xE8B8;</i><br />Settings</a></li>                            
                ...
                <td class="menub">
                    <dl>
                        ...
                        <dd>
                            <ul>
                                <li><a href="changepw.php" class="menulink">Change Password</a></li>
                            </ul>
                        </dd>
                    </dl>

                    <!-- START BLOCK : dropsettings -->
                    <dl>
                        <dt>Drop Settings</dt>
                        <dd>
                            <ul>
                                <li><a href="droplist.php" class="menulink">Edit Droplist</a></li>
                            </ul>
                        </dd>
                    </dl>                        
                    <!-- END BLOCK : dropsettings -->
                    ...
                    <dl>
                        ...
                        <dd>
                            <ul>
                                ...
                                <!-- END BLOCK : gmlist -->
                                <li><a href="editgm.php" class="menulink"><i>Create new user</i></a></li>
                            </ul>
                        </dd>
                    </dl>
                    <!-- END BLOCK : showgms -->

                    <!-- START BLOCK : showroles -->
                    <dl>
                        <dt>ACP Roles</dt>
                        <dd>
                            <ul>
                                ...
                                <li><a href="{url}" class="menulink">{name}</a></li>
                                <!-- END BLOCK : rolelist -->
                                <li><a href="roles.php" class="menulink"><i>Create new role</i></a></li>
                            </ul>
                        </dd>
                    </dl>
                    <!-- END BLOCK : showroles -->
